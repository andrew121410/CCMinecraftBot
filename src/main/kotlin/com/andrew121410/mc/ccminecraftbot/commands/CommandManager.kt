...
public class CommandManager {
    ...
    public void onChat(String sender, String fullCommand) {
        ...
        if (command.equalsIgnoreCase("inv_move_cursor") && args.length == 1) {
            this.ccBotMinecraft.getPlayer().getPlayerInventory().moveSlotToCursor(Integer.parseInt(args[0]));
            ...
            sendMessage("Food was found: " + inventorySlot.getItem());
            return;
        ...
        } else if (command.equalsIgnoreCase("path_go_to") && args.length == 3) {
